...
public class IntakeIOTalonFX implements IntakeIO {
    private TalonFX intakeMotor = new TalonFX(IntakeIOConstants.INTAKE_MOTOR_ID);
    private TalonFX intakeFollower = new TalonFX(IntakeIOConstants.INTAKE_MOTOR_FOLLOWER_ID);
